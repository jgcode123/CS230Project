...
class pix2pix(object):
    ...
    def load_random_samples(self):
        data = np.random.choice(glob('./datasets/{}/val/*.bmp'.format(self.dataset_name)), self.batch_size)
    ...
    def train(self, args):
        ...
        for epoch in xrange(args.epoch):
            data = glob('./datasets/{}/train/*.bmp'.format(self.dataset_name))
    ...
    def test(self, args):
        ...
        sample_files = glob('./datasets/{}/val/*.bmp'.format(self.dataset_name))

        # sort testing input
        n = [int(i) for i in map(lambda x: x.split('/')[-1].split('.bmp')[0], sample_files)]
